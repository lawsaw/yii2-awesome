...
class Lang extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['default', 'date_update', 'date_create'], 'default', 'value' => null],
    ...
    /**
     * this func returns list of available languages
     * needed for multilangual behavior
     * @see https://github.com/OmgDef/yii2-multilingual-behavior
     */
    static function getLangList()
    {
        $langs = [];
        foreach(Lang::find()->all() as $item)
        {
            $langs[$item->url] = $item->name;
        }
